import getpass, subprocess, psutil, shutil, os, colorama, readchar, requests
...
if __name__ == "__main__":
    ...
    try:
        print(f"[{datetime.now().strftime('%H:%M:%S')}] Attempting to remove old roblox tracer files.\n")
    ...
    print(f"[{datetime.now().strftime('%H:%M:%S')}] Error Code 403 has been successfully removed from RobloxPlayerLauncher {get_version()}.\n")
